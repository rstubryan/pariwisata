function kontak() {
  ...
  kontaks.innerHTML = ` 
    ...
    <section id="contact">
      ...
      <aside class="container mx-auto w-[1000px] p-4 my-8 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 lg:p-8" aria-label="Subscribe to the newsletter">
      <h3 class="mb-3 text-xl font-medium text-gray-900">Newsletter</h3>
